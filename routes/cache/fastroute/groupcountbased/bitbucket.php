<?php return array (
  ...
  array (
    ...
    array (
      ...
      13 => 
      array (
        'regex' => '~^(?|/teams/([^/]+)/following|/teams/([^/]+)/members()|/teams/([^/]+)/permissions()()|/teams/([^/]+)/permissions/repositories()()()|/teams/([^/]+)/permissions/repositories/([^/]+)()()()|/teams/([^/]+)/pipelines_config/variables/()()()()()|/teams/([^/]+)/pipelines_config/variables/([^/]+)()()()()()|/teams/([^/]+)/projects/()()()()()()()|/teams/([^/]+)/projects/([^/]+)()()()()()()()|/teams/([^/]+)/search/code()()()()()()()()())$~',
        'routeMap' => 
        array (
          2 => 
          array (
      ...
      14 => 
      array (
        'regex' => '~^(?|/teams/([^/]+)/repositories|/user/emails/([^/]+)()|/users/([^/]+)()()|/users/([^/]+)/pipelines_config/variables/()()()|/users/([^/]+)/pipelines_config/variables/([^/]+)()()()|/users/([^/]+)/properties/([^/]+)/([^/]+)()()()|/users/([^/]+)/search/code()()()()()()|/users/([^/]+)/ssh\\-keys()()()()()()()|/users/([^/]+)/ssh\\-keys/([^/]+)()()()()()()()|/users/([^/]+)/members()()()()()()()()())$~',
        'routeMap' => 
        array (
          2 => 
          array (
      ...
      15 => 
      array (
        'regex' => '~^(?|/users/([^/]+)/repositories|/workspaces/([^/]+)()|/workspaces/([^/]+)/hooks()()|/workspaces/([^/]+)/hooks/([^/]+)()()|/workspaces/([^/]+)/members()()()()|/workspaces/([^/]+)/members/([^/]+)()()()()|/workspaces/([^/]+)/permissions()()()()()()|/workspaces/([^/]+)/permissions/repositories()()()()()()()|/workspaces/([^/]+)/permissions/repositories/([^/]+)()()()()()()()|/workspaces/([^/]+)/pipelines\\-config/identity/oidc/\\.well\\-known/openid\\-configuration()()()()()()()()())$~',
        'routeMap' => 
        array (
          2 => 
          array (
      ...
      16 => 
      array (
        'regex' => '~^(?|/workspaces/([^/]+)/pipelines\\-config/identity/oidc/keys\\.json|/workspaces/([^/]+)/pipelines\\-config/variables()|/workspaces/([^/]+)/pipelines\\-config/variables/([^/]+)()|/workspaces/([^/]+)/projects()()()|/workspaces/([^/]+)/projects/([^/]+)()()()|/workspaces/([^/]+)/search/code()()()()())$~',
        'routeMap' => 
        array (
          2 => 
          array (
